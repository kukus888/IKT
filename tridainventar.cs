...
namespace IKT
{
	public class tridainventar
	{
		...
		public void action(promenne hodnoty) {
			if (hodnoty.zlato == null || hodnoty.odolnost == null || hodnoty.inventar == null) {
				return;
			}
					...
					if (hodnoty.inventar [volbainventar, 2] == "Most") {
						...
						while (invpouzit) {
							...
							if (vstupinvpouzit.Key == ConsoleKey.Enter && volbainvpouzit == 0) {//Postavit
								...
								try {
									if (hodnoty.mapa [hodnoty.charakterX - 1, hodnoty.charakterY] == 3 && pokracovatmost == true) {
										hodnoty.mapa [hodnoty.charakterX - 1, hodnoty.charakterY] = 8;
										placedmost = true;
								...
								try {
									if (hodnoty.mapa [hodnoty.charakterX, hodnoty.charakterY - 1] == 3 && pokracovatmost == true) {
										hodnoty.mapa [hodnoty.charakterX, hodnoty.charakterY - 1] = 8;
										placedmost = true;
										pokracovatmost = false;
									}
								} catch (System.IndexOutOfRangeException) {
